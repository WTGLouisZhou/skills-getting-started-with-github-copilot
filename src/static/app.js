          ...
          .map(
            (participant) => `
              <li>
                ...
                <button class="participant-remove" type="button" data-activity="${escapeHtml(name)}" data-participant="${escapeHtml(participant)}" aria-label="Unregister ${escapeHtml(participant)}" title="Unregister participant">&#10005;</button>
              </li>`
          )
          .join("");
